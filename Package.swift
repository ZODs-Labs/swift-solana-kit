...
let package = Package(
    ...
    targets: [
        ...
        .testTarget(name: "AccountsTests", dependencies: ["Accounts", "Addresses", "CodecsCore", "RpcSpecTypes", "RpcTypes", "SolanaErrors"], swiftSettings: swiftSettings),
        .testTarget(name: "SysvarsTests", dependencies: ["Sysvars"], swiftSettings: swiftSettings),
        .testTarget(name: "InstructionPlansTests", dependencies: ["Addresses", "InstructionPlans", "Instructions", "Keys", "TransactionMessages"], swiftSettings: swiftSettings),
        .testTarget(name: "PluginCoreTests", dependencies: ["PluginCore"], swiftSettings: swiftSettings),
        .testTarget(name: "PluginInterfacesTests", dependencies: ["Addresses", "InstructionPlans", "PluginInterfaces", "Promises", "RpcApi", "RpcSubscriptionsApi", "Signers"], swiftSettings: swiftSettings),
        .testTarget(name: "ProgramClientCoreTests", dependencies: ["Addresses", "CodecsCore", "InstructionPlans", "Instructions", "ProgramClientCore"], swiftSettings: swiftSettings),
        .testTarget(name: "ProgramsTests", dependencies: ["Addresses", "Programs", "SolanaErrors"], swiftSettings: swiftSettings),
        .testTarget(name: "RpcGraphqlTests", dependencies: ["RpcGraphql"], swiftSettings: swiftSettings),
